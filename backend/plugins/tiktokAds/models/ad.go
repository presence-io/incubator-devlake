...
type AdResponse struct {
	...
	Data struct {
		...
		Creatives []TiktokAdsAd `json:"creatives"`
...
type TiktokAdsAd struct {
	...
	CreativeId   uint64 `gorm:"column:creative_id;primaryKey" json:"creative_id,string"`
	...
	AdGroupID        uint64 `gorm:"column:adgroup_id,string" json:"adgroup_id,string"`
