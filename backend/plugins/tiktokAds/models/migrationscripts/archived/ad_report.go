...
type TiktokAdsAdReport struct {
	...
	CallToAction               string  `json:"call_to_action" gorm:"column:call_to_action"`
	...
	ImageMode                 string  `json:"image_mode" gorm:"column:image_mode"`
