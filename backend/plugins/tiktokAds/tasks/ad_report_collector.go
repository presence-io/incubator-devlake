...
var _ plugin.SubTaskEntryPoint = CollectAdReport

const RAW_AD_REPORT_TABLE = "tiktokads_ad_report"

func CollectAdReport(taskCtx plugin.SubTaskContext) errors.Error {
...
var CollectAdReportMeta = plugin.SubTaskMeta{
	Name:             "CollectAdReport",
	EntryPoint:       CollectAdReport,
	EnabledByDefault: true,
	Description:      "Collect AdReport data from Tiktokads api",
	DomainTypes:      []string{},
}
