...
const RAW_AD_GROUP_TABLE = "tiktokad_ad_group"

var _ plugin.SubTaskEntryPoint = CollectAdGroup

func CollectAdGroup(taskCtx plugin.SubTaskContext) errors.Error {
	...
	collector, err := api.NewApiCollector(api.ApiCollectorArgs{
		RawDataSubTaskArgs: api.RawDataSubTaskArgs{
			...
			Table: RAW_AD_GROUP_TABLE,
		},
		PageSize:      100,
		ApiClient:     data.ApiClient,
		Incremental:   false,
		UrlTemplate:   "v1.3/adgroup/get/",
...
var CollectAdGroupMeta = plugin.SubTaskMeta{
	Name:             "CollectAdGroup",
	EntryPoint:       CollectAdGroup,
	EnabledByDefault: true,
	Description:      "Collect AdGroup data from Tiktokad api",
	DomainTypes:      []string{},
}
