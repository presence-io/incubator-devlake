...
var _ plugin.SubTaskEntryPoint = ExtractAdGroup

func ExtractAdGroup(taskCtx plugin.SubTaskContext) errors.Error {
...
var ExtractAdGroupMeta = plugin.SubTaskMeta{
	Name:             "ExtractAdGroup",
	EntryPoint:       ExtractAdGroup,
	EnabledByDefault: true,
	Description:      "Extract raw data into tool layer table tiktokads_ad_group",
	DomainTypes:      []string{},
}
